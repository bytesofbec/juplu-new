...
"""
Django settings for juplu project.
...
SECRET_KEY = 'gowvh$wq^*z-3s0fl^&!7*k)ai=^2j3t=j@=!g32n$biesj1y='
...
ROOT_URLCONF = 'juplu.urls'



WSGI_APPLICATION = 'juplu.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'juplu', 'static'),
)
SITE_ID = 1
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'juplu', 'templates'),],
        'OPTIONS': {
            'context_processors': [
